...
def build_candidate_payload(*, skill_name: str, workflow: dict[str, Any] | None = None, transcript: dict[str, Any] | None = None, failure: dict[str, Any] | None = None, owner: str = "agent-skill-platform") -> dict[str, Any]:
