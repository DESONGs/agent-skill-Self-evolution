...
from .registry import build_engine_app, build_registry_app, execute_skill, find_skill, ingest_feedback, open_registry, publish_package, resolve_install_bundle, submit_promotion
    ...
    def get_registry_skill_projection(
        ...
        *,
        ...
        return open_registry(
            ...
            mode=registry_mode,
            base_url=registry_base_url,
        ).get_skill_projection(skill_id, version_id=version_id)

    def list_registry_skill_projections(
        self,
        *,
        registry_root: str | Path | None = None,
        registry_mode: str | None = None,
