...
public class RouteSecurityPolicyRegistry {
    ...
    private static final List<RouteAuthorizationPolicy> AUTHORIZATION_POLICIES = List.of(
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/skills/*/*/versions/*"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/skills/*/*/distribution"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/skills/*/*/versions/*/distribution"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/v1/skills/*/*/tags/*/distribution"),
            ...
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/web/skills/*/*/versions/*"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/web/skills/*/*/distribution"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/web/skills/*/*/versions/*/distribution"),
            RouteAuthorizationPolicy.permitAll(HttpMethod.GET, "/api/web/skills/*/*/tags/*/distribution"),
            ...
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/v1/internal/skill-feedback"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.GET, "/api/v1/internal/skills/*/*/distribution"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.GET, "/api/v1/internal/skills/*/*/versions/*/distribution"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.GET, "/api/v1/internal/skills/*/*/tags/*/distribution"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/v1/internal/candidates"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.GET, "/api/v1/internal/candidates"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.GET, "/api/v1/internal/candidates/*"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/v1/internal/candidates/*/promotion-decisions"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.POST, "/api/v1/internal/candidates/*/publish"),
            RouteAuthorizationPolicy.authenticated(HttpMethod.GET, "/api/v1/internal/governance-signals/skills"),
    ...
    private static final List<ApiTokenPolicy> API_TOKEN_POLICIES = List.of(
            ...
            ApiTokenPolicy.require(HttpMethod.POST, "/api/v1/internal/skill-feedback", "skill:feedback"),
            ApiTokenPolicy.require(HttpMethod.GET, "/api/v1/internal/skills/*/*/distribution", "skill:internal-read"),
            ApiTokenPolicy.require(HttpMethod.GET, "/api/v1/internal/skills/*/*/versions/*/distribution", "skill:internal-read"),
            ApiTokenPolicy.require(HttpMethod.GET, "/api/v1/internal/skills/*/*/tags/*/distribution", "skill:internal-read"),
            ApiTokenPolicy.require(HttpMethod.POST, "/api/v1/internal/candidates", "skill:candidate"),
            ApiTokenPolicy.require(HttpMethod.GET, "/api/v1/internal/candidates", "skill:internal-read"),
            ApiTokenPolicy.require(HttpMethod.GET, "/api/v1/internal/candidates/*", "skill:internal-read"),
            ApiTokenPolicy.require(HttpMethod.POST, "/api/v1/internal/candidates/*/promotion-decisions", "skill:candidate"),
            ApiTokenPolicy.require(HttpMethod.POST, "/api/v1/internal/candidates/*/publish", "skill:candidate"),
            ApiTokenPolicy.require(HttpMethod.GET, "/api/v1/internal/governance-signals/skills", "skill:governance")
    );
