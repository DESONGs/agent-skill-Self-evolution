...
class SkillDownloadServiceTest {
    ...
    @Mock
    private SkillFeedbackIngestionService skillFeedbackIngestionService;
    ...
    void setUp() {
        ...
        lenient().when(skillFeedbackIngestionService.ingest(
                anyString(),
                anyString(),
                anyString(),
                anyLong(),
    ...
    void testDownloadLatest_Success() throws Exception {
        ...
        verify(skillFeedbackIngestionService).ingest(
                startsWith("download:1:10:"),
                eq("DOWNLOAD"),
                eq("SKILL_VERSION"),
                eq(1L),
                eq(10L),
