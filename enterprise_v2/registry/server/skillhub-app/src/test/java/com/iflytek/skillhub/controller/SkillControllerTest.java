...
class SkillControllerTest {
    ...
    @Test
    void getLatestDistributionShouldReturnUnifiedEnvelope() throws Exception {
        when(skillDistributionAppService.getLatestDistribution(
                eq("team"),
                eq("demo"),
                eq((String) null),
                eq(Map.<Long, NamespaceRole>of())))
                .thenReturn(new SkillDistributionResponse(
                        1L,
                        "team",
                        "demo",
                        "Demo",
                        ...
                        new SkillDistributionResponse.BundleDescriptor(
        ...
        mockMvc.perform(get("/api/v1/skills/team/demo/distribution"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.code").value(0))
                .andExpect(jsonPath("$.data.namespace").value("team"))
                .andExpect(jsonPath("$.data.bundle.storageKey").doesNotExist())
