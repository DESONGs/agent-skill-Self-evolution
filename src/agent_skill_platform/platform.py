...
class AgentSkillPlatform:
    def __init__(self, settings: EnterpriseSettings | None = None):
        self.settings = settings or EnterpriseSettings.from_env()
    ...
    def publish_package(self, source: str | Path, *, registry_root: str | Path | None = None) -> dict[str, Any]:
        return self._container().registry_service.publish_package(source)
    ...
    def get_registry_skill_projection(
        ...
        *,
        ...
        return self._container().registry_service.get_skill_projection(skill_id, version_id=version_id)

    def list_registry_skill_projections(self, *, registry_root: str | Path | None = None) -> list[dict[str, Any]]:
        return self._container().registry_service.list_skill_projections()
    ...
    def find_skill(
        ...
        **kwargs: Any,
        ...
        return self._container().projection_service.find_skill(query, **kwargs).to_dict()
    ...
    def execute_skill(
        ...
        **kwargs: Any,
        ...
        if kwargs and isinstance(request, dict):
            payload = dict(request)
            payload.update(kwargs)
            request = payload
        return self._container().execution_service.execute(request).to_dict()
