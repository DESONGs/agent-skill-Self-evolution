...
public class SkillController extends BaseApiController {
    ...
    public ApiResponse<SkillDistributionResponse> getLatestDistribution(
            @PathVariable String namespace,
            @PathVariable String slug,
            @RequestAttribute(value = "userId", required = false) String userId,
            @RequestAttribute(value = "userNsRoles", required = false) Map<Long, NamespaceRole> userNsRoles) {

        SkillDistributionResponse response = skillDistributionAppService.getLatestDistribution(
                namespace,
                slug,
                userId,
                userNsRoles != null ? userNsRoles : Map.of()
    ...
    public ApiResponse<SkillDistributionResponse> getVersionDistribution(
            @PathVariable String namespace,
            @PathVariable String slug,
            @PathVariable String version,
            @RequestAttribute(value = "userId", required = false) String userId,
        ...
        SkillDistributionResponse response = skillDistributionAppService.getVersionDistribution(
                namespace,
                slug,
                version,
                userId,
    ...
    public ApiResponse<SkillDistributionResponse> getTagDistribution(
            @PathVariable String namespace,
            @PathVariable String slug,
            @PathVariable String tagName,
            @RequestAttribute(value = "userId", required = false) String userId,
        ...
        SkillDistributionResponse response = skillDistributionAppService.getTagDistribution(
                namespace,
                slug,
                tagName,
                userId,
