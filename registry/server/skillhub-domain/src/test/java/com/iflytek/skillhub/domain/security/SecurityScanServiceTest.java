...
class SecurityScanServiceTest {
    ...
    @Test
    void processScanResult_safeVerdictMovesVersionToPendingReview() {
        SecurityAudit audit = new SecurityAudit(42L, ScannerType.SKILL_SCANNER);
        SkillVersion version = new SkillVersion(8L, "1.0.0", "publisher-1");
        ...
        assertThat(audit.getMaxSeverity()).isEqualTo("NONE");
    ...
    @Test
    void processScanResult_nonSafeVerdictMovesVersionToScanFailed() {
        SecurityAudit audit = new SecurityAudit(42L, ScannerType.SKILL_SCANNER);
        SkillVersion version = new SkillVersion(8L, "1.0.0", "publisher-1");
