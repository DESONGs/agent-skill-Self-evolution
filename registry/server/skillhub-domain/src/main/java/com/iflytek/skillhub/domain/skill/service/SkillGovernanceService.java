...
public class SkillGovernanceService {
    ...
    public Skill hideSkill(Long skillId, String actorUserId, String clientIp, String userAgent, String reason) {
        ...
        eventPublisher.publishEvent(new SkillStatusChangedEvent(skill.getId(), skill.getStatus(), skill.getStatus()));
        return saved;
    }
    ...
    private Skill archiveSkillInternal(Skill skill,
        ...
        refreshLatestPublishedPointer(skill, actorUserId);
        skill.setUpdatedBy(actorUserId);
        Skill saved = skillRepository.save(skill);
    ...
    public SkillVersion yankVersion(Long versionId, String actorUserId, String clientIp, String userAgent, String reason) {
        ...
        eventPublisher.publishEvent(new SkillStatusChangedEvent(version.getSkillId(), SkillStatus.ACTIVE, SkillStatus.ACTIVE));
        return saved;
    }
    ...
    private void refreshLatestPublishedPointer(Skill skill, String actorUserId) {
        Long latestPublishedVersionId = findLatestPublishedVersionId(skill.getId());
        if (!Objects.equals(skill.getLatestVersionId(), latestPublishedVersionId)) {
            skill.setLatestVersionId(latestPublishedVersionId);
            skill.setUpdatedBy(actorUserId);
            skillRepository.save(skill);
        }
    }
