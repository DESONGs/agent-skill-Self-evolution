...
class PostgresSearchRebuildServiceTest {
    ...
    void rebuildBySkill_shouldIndexFrontmatterFieldsAndKeywordsWithoutBody() {
        ...
        when(skillVersionRepository.findByIdIn(List.of(99L))).thenReturn(List.of(version));
    ...
    @Test
    void rebuildBySkill_shouldUseLatestPublishedVersionWhenLatestPointerIsNotPublished() {
        SkillRepository skillRepository = mock(SkillRepository.class);
        NamespaceRepository namespaceRepository = mock(NamespaceRepository.class);
        SkillVersionRepository skillVersionRepository = mock(SkillVersionRepository.class);
        SearchIndexService searchIndexService = mock(SearchIndexService.class);
        ...
        SkillVersion draftVersion = new SkillVersion(1L, "1.2.9", "owner-1");
        draftVersion.setStatus(SkillVersionStatus.DRAFT);
        setField(draftVersion, "id", 100L);

        SkillVersion publishedVersion = new SkillVersion(1L, "1.3.0", "owner-1");
        publishedVersion.setStatus(SkillVersionStatus.PUBLISHED);
        setField(publishedVersion, "id", 101L);
        publishedVersion.setParsedMetadataJson("""
                {
                  "name": "Smart Agent",
                  "description": "Builds workflows",
                  "version": "1.3.0",
        ...
        when(skillRepository.findById(1L)).thenReturn(Optional.of(skill));
        when(namespaceRepository.findById(7L)).thenReturn(Optional.of(namespace));
        when(skillVersionRepository.findById(101L)).thenReturn(Optional.of(publishedVersion));
        when(skillVersionRepository.findByIdIn(List.of(100L))).thenReturn(List.of(draftVersion));
        when(skillVersionRepository.findBySkillIdInAndStatus(List.of(1L), SkillVersionStatus.PUBLISHED))
    ...
    @Test
    void rebuildBySkill_shouldRemoveSearchDocumentWhenNoPublishedVersionExists() {
        SkillRepository skillRepository = mock(SkillRepository.class);
        NamespaceRepository namespaceRepository = mock(NamespaceRepository.class);
        SkillVersionRepository skillVersionRepository = mock(SkillVersionRepository.class);
        SearchIndexService searchIndexService = mock(SearchIndexService.class);
        ...
        skill.setDisplayName("Smart Agent");
        skill.setSummary("Builds workflows");
        skill.setLatestVersionId(200L);

        SkillVersion draftVersion = new SkillVersion(1L, "1.0.0", "owner-1");
        draftVersion.setStatus(SkillVersionStatus.DRAFT);
        setField(draftVersion, "id", 200L);

        when(skillRepository.findById(1L)).thenReturn(Optional.of(skill));
        when(skillVersionRepository.findByIdIn(List.of(200L))).thenReturn(List.of(draftVersion));
        when(skillVersionRepository.findBySkillIdInAndStatus(List.of(1L), SkillVersionStatus.PUBLISHED))
                .thenReturn(List.of());
    ...
    void rebuildBySkill_shouldKeepChineseSummarySearchableThroughSearchText() {
        ...
        when(skillVersionRepository.findByIdIn(List.of(102L))).thenReturn(List.of(version));
        when(skillVersionRepository.findBySkillIdInAndStatus(List.of(1L), SkillVersionStatus.PUBLISHED))
                .thenReturn(List.of(version));
    ...
    void rebuildBySkill_shouldAppendLabelTranslationsIntoKeywords() {
        ...
        when(skillVersionRepository.findByIdIn(List.of(103L))).thenReturn(List.of(version));
        when(skillVersionRepository.findBySkillIdInAndStatus(List.of(1L), SkillVersionStatus.PUBLISHED))
                .thenReturn(List.of(version));
